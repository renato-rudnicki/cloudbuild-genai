...
class vertex_ai_pipeline:
    def __init__(self,
                 ...
                 PROJECT_ID: str = "prj-n-mlmachine-learning-cwps",
                 # Replace the {prod-project_id} for your prod-project-id
                 PROD_PROJECT_ID: str = "prj-p-mlmachine-learning-uqmo",
                 ...
                 # Replace the prj-n-shared-restricted-bac1 with your project_id
                 DATAFLOW_SUBNET: str = "https://www.googleapis.com/compute/v1/projects/prj-n-shared-restricted-bac1/regions/us-central1/subnetworks/sb-n-shared-restricted-us-central1",
                 JOB_NAME: str = "census-ingest",
                 # Replace the 817033414767 with your prj_n_machine_learning_number 
                 SERVICE_ACCOUNT: str = "817033414767-compute@developer.gserviceaccount.com",
                 # Replace the 1083732227192 with your prj_p_machine_learning_project_number
                 PROD_SERVICE_ACCOUNT: str = "1083732227192-compute@developer.gserviceaccount.com",
                 # Replace the dataflow-sa@prj-n-mlmachine-learning-cwps.iam.gserviceaccount.com with your dataflow-sa from non-prod machine_learning_project
                 DATAFLOW_SA: str = "dataflow-sa@prj-n-mlmachine-learning-cwps.iam.gserviceaccount.com",
                 ):
        ...
        self.SRC = SRC
        self.BUILD = BUILD
        # Replace the prj-c-mlartifacts-g0d6 with the name of the image in artifact project of the common folder
        self.Image = "us-central1-docker.pkg.dev/prj-c-mlartifacts-g0d6/c-publish-artifacts/vertexpipeline:v2"
        ...
        self.deployment_config = {
            ...
            "encryption": 'projects/prj-p-kms-ncnv/locations/us-central1/keyRings/sample-keyring/cryptoKeys/prj-p-mlmachine-learning',
    ...
    def execute(self):
        pipeline = aiplatform.PipelineJob(
            ...
            encryption_spec_key_name='projects/prj-n-kms-nlxg/locations/us-central1/keyRings/sample-keyring/cryptoKeys/prj-n-mlmachine-learning',
            parameter_values={
...
if __name__ == "__main__":
    pipeline = vertex_ai_pipeline(
        ...
        PROJECT_ID="prj-n-mlmachine-learning-cwps", \
        # Replace with your Machine Learning prod project ID
        PROD_PROJECT_ID='prj-p-mlmachine-learning-uqmo', \
        REGION="us-central1", \
        # Replace with your bucket in non-prod ID
        BUCKET_URI="gs://bkt-n-ml-storage-ds31fbez", \
        DATA_PATH="data", \
        ...
        DATAFLOW_SUBNET="https://www.googleapis.com/compute/v1/projects/prj-n-shared-restricted-bac1/regions/us-central1/subnetworks/sb-n-shared-restricted-us-central1", \
        JOB_NAME="census-ingest", \
        # Replace the 817033414767 with your Non-production Machine Learning Project Number
        SERVICE_ACCOUNT="817033414767-compute@developer.gserviceaccount.com", \
        # Replace the 1083732227192 with your Production Machine Learning Project Number
        PROD_SERVICE_ACCOUNT="1083732227192-compute@developer.gserviceaccount.com",
        # Replace the prj-n-mlmachine-learning-cwps with your Non-production Machine Learning Project ID
        DATAFLOW_SA="dataflow-sa@prj-n-mlmachine-learning-cwps.iam.gserviceaccount.com",
    )
